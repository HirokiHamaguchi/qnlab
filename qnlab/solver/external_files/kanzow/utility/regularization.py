...
from qnlab.solver.external_files.kanzow.utility import morethuente, parameters
...
def genericMonotone(lmData, updateCalculator, directionCalculator, f, Df, x):
    ...
    xn, fn, gn, t, exls, it = morethuente.cvsrch(
        fun, len(x), x, fx, gx, d, 1, 1e-4, 0.9, 1e-16, 1e-20, 1e20, 20
    )
