...
\newenvironment{MPCchange}{%
    \ifdefined\MPCRevision\color{red}\fi
}{}
\newcommand{\MPCchanged}[1]{\begin{MPCchange}#1\end{MPCchange}}
...
The first draft of the manuscript was written by Hiroki Hamaguchi\MPCchanged{,} and all authors commented on previous versions of the manuscript.
All authors read and approved the final manuscript.

\subsection*{Data Availability}

All data analyzed during this study are publicly available.
URLs are included in this article.

\subsection*{Code Availability}

The code used in this study is publicly available at the following GitHub repository: \\
\url{https://github.com/HirokiHamaguchi/qnlab}.
