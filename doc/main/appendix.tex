...
\begin{MPCchange}
The normalized upper-curvature inequality is enforced directly by \cref{eq:implemented_cautious_test}, while the fixed shift in \cref{eq:proposed_choice_of_Bk} supplies the lower spectral bound.
