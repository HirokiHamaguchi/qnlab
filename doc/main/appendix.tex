...
Over the $1{,}100$ function-noise instances, the no-restart and restart variants attain \(\gtol = 10^{-2}\) on $85.1\%$ and $87.6\%$, respectively, corresponding to $164$ and $136$ instances that do not attain the tolerance.
Among the $928$ instances solved by both variants, restart uses fewer oracle calls on $185$, the same number on $654$, and more on $89$.
The median call ratio is $1.00$, and its geometric mean is $0.895$.
The restart count has mean $1.48$, median zero, and maximum ten, with the cap reached on $62$ instances.
...
\begin{figure}[t]
    ...
    \end{subfigure}
    \caption{Performance profile for the restart ablation on the same $1{,}100$ paired function-noise instances as the primary experiment.
