...
\end{MPCchange}
\MPCchanged{Notably, the proposed sufficient-decrease test does not use Wolfe-type conditions and therefore does not require a gradient evaluation at each trial point.}
\MPCchanged{This removes trial-gradient errors from that test, but gradient inaccuracies can still affect its current-gradient term, the search direction, quasi-Newton updates, the regularization scale, and the optional trial-step adjustment used in the implementation.}
\begin{MPCchange}
