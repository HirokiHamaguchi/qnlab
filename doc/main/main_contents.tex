...
The primary implementation does not restart this accumulator; the earlier heuristic restart is disabled by default and is considered only as an ablation.
This removes the unproved finite-restart qualification from the convergence claim.
\end{MPCchange}
...
Therefore, success in the joint-noise experiment is empirical evidence of robustness beyond the theorem and is not presented as validation of the exact-gradient complexity result.
