...
\begin{proof}
    ...
    \end{equation}
    Then, combining \cref{eq:sufficient_decrease,eq:intermediate_bound_on_overline_delta_plus_Delta} and summing over $k \in K^0$ gives
    \begin{equation*}
...
Separately, there exist function-based modified secant condition~\citep{zhangPropertiesNumericalPerformance2001,babaie-kafakiTwoNewConjugate2010,yabeLocalSuperlinearConvergence2007,hassanModifiedSecantEquation2023} that adjusts the secant equation using available function values when those quantities are reliable. Such adjustments aim to improve practical convergence behavior.
...
The results indicate that our methods are robust and effective, particularly in noisy or low-precision environments where traditional line search methods may struggle.
