...
\MPCchanged{All experiments were conducted on an Apple Mac Pro (Late 2013).}
...
\begin{MPCchange}
We report separately the function-value noise experiment and the joint noise experiment described in \cref{sssec:problems}.
...
All profiles in the main text use the analyzed method without restarts.
...
\begin{table}[h!]
    ...
    Parentheses give the standard deviation of the solved percentage over the five seeds, and oracle-call medians are computed over successful runs.}
    ...
    \begin{tabular}{lrrrr}
        ...
        \midrule
        \texttt{Ours}            & $85.1\ (0.60)$ & $62$  & $83.6\ (0.64)$ & $63$  \\
        \texttt{Ours-MS}         & $85.5\ (0.18)$ & $67$  & $84.8\ (0.22)$ & $71$  \\
        \texttt{Ours-SP}         & $83.9\ (0.46)$ & $62$  & $80.6\ (0.62)$ & $62$  \\
        \texttt{NTQN}            & $81.2\ (1.34)$ & $64$  & $71.9\ (0.34)$ & $62$  \\
        \texttt{Reg}             & $77.8\ (1.01)$ & $60$  & $73.5\ (1.21)$ & $56$  \\
        \texttt{Reg-Sec}         & $74.0\ (0.78)$ & $54$  & $73.0\ (1.21)$ & $62$  \\
        \texttt{ASTR1-Adagrad}   & $41.5\ (1.13)$ & $131$ & $42.8\ (0.83)$ & $150$ \\
        \bottomrule
    \end{tabular}
    \end{MPCchange}
\end{table}
...
\begin{MPCchange}
Underestimating \(\feps\) can violate the assumed error bound and does not uniformly improve performance across the two variants.
Overestimating it preserves the error model, but the results show that an excessively large allowance can reduce practical efficiency by keeping the method in the conservative $K^+$ regime more often.
