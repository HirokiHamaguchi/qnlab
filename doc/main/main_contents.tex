...
\end{equation}
\end{MPCchange}
\MPCchanged{The direction is then computed from the raw curvature pairs using the standard two-loop recursion~\citep{liuLimitedMemoryBFGS1989,nocedal1999numerical}.}
\MPCchanged{When the memory is empty, the implementation uses $d_k=-g_k/(\rho_0+\omega_{\min}+\mu_k)$.}
