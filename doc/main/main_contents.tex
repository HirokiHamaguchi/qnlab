...
\begin{itemize}
    \item (\texttt{Ours}): Our proposed regularized quasi-Newton method
          \begin{itemize}
              ...
              \MPCchanged{\item (\texttt{Ours-R}) means the variant incorporating the optional accumulator restart described in \cref{sec:proposed_choice_mu} and evaluated in \cref{app:restart_experiment}.}
          \end{itemize}
...
\MPCchanged{All experiments were conducted on an Apple Mac Pro (Late 2013) with a 3.7~GHz quad-core Intel Xeon E5 processor and 12~GB of 1866~MHz DDR3 ECC memory.}
...
The optional accumulator-restart variants are evaluated separately under the function-value-noise setting in \cref{app:restart_experiment}.}
...
\begin{table}[t]
    ...
    Success rates are reported as the mean $\pm$ standard deviation over the five seeds, in percentage points, and oracle-call medians are computed over successful runs.}
    ...
    \begin{tabular}{lrrrr}
        ...
        \midrule
        \texttt{Ours}            & $85.1 \pm 0.60$ & $62$  & $83.6 \pm 0.64$ & $63$  \\
        \texttt{Ours-MS}         & $85.5 \pm 0.18$ & $67$  & $84.8 \pm 0.22$ & $71$  \\
        \texttt{Ours-SP}         & $83.9 \pm 0.46$ & $62$  & $80.6 \pm 0.62$ & $62$  \\
        \texttt{NTQN}            & $81.2 \pm 1.34$ & $64$  & $71.9 \pm 0.34$ & $62$  \\
        \texttt{Reg}             & $77.8 \pm 1.01$ & $60$  & $73.5 \pm 1.21$ & $56$  \\
        \texttt{Reg-Sec}         & $74.0 \pm 0.78$ & $54$  & $73.0 \pm 1.21$ & $62$  \\
        \texttt{ASTR1-Adagrad}   & $41.5 \pm 1.13$ & $131$ & $42.8 \pm 0.83$ & $150$ \\
        \bottomrule
    \end{tabular}
    \end{MPCchange}
\end{table}
