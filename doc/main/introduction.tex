...
\begin{table*}[t]
    ...
    \caption{
        ...
        The asterisk of our method indicates that gradient noise is outside the current analysis and is considered only in joint-noise stress tests.
    }
    \label{tab:related_work_comparison}
        \begin{tabular}{@{}>{\centering\arraybackslash}p{0.20\linewidth}cccc>{\centering\arraybackslash}p{0.25\linewidth}@{}}
            \toprule
            Algorithm
             & Uses $f$
             & Noisy $f$
...
The another closely related methods are OFFO~\citep{Gratton08022024,grattonOFFOMinimizationAlgorithms2023} and Noise Tolerant Quasi-Newton (NTQN) methods~\citep{shiNoiseTolerantQuasiNewtonAlgorithm2022}.
...
NTQN instead has the complementary advantage of accommodating bounded gradient errors, which our theory does not cover.
