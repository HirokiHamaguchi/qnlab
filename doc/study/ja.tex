...
\begin{figure}[t]
    \centering
    \includegraphics[width=\textwidth]{../imgs/quasi_newton/pd.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\textwidth]{../imgs/quasi_newton/newton_failure_sqrt_function_1.1.png}
...
\begin{figure}[H]
    \begin{minipage}{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../imgs/quasi_newton/newton_failure_strongly_convex_function_0.1_-4.png}
    \end{minipage}%
    \begin{minipage}{0.5\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../imgs/quasi_newton/newton_failure_strongly_convex_function_0.01_-4.png}
    \end{minipage}
...
\begin{figure}[htbp]
    \begin{minipage}{0.33\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../imgs/quasi_newton/quasi_newton_1.png}
    \end{minipage}%
    \begin{minipage}{0.33\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../imgs/quasi_newton/quasi_newton_2.png}
    \end{minipage}%
    \begin{minipage}{0.33\textwidth}
        \centering
        \includegraphics[width=\textwidth]{../imgs/quasi_newton/quasi_newton_3.png}
    \end{minipage}
    \caption{
        準Newton法の概念図。
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=0.5\textwidth]{../imgs/paperScreenShots/kanamori.png}
\end{figure}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{../imgs/quasi_newton/bfgs_vs_dfp_100.png}
...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=\textwidth]{../imgs/quasi_newton/bfgs_vs_dfp_0.1.png}
