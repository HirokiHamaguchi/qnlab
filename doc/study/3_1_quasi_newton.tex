...
\ifEn
    ...
    The Dennis--Mor{\'e} condition characterizes when a Newton-like iteration achieves this rate~\citep{dennisMoreCharacterizationSuperlinear1974,dennisjr.QuasiNewtonMethodsMotivation1977}. Consider the iteration
\else
    が成り立つことをいいます。したがって、一定の収縮率が1未満である Q-線形収束よりも強く、収縮率そのものが0へ近づきます。

    Newton 型の反復がこの収束率を達成するための条件の一つがDennis--Mor{\'e} 条件です~\citep{dennisMoreCharacterizationSuperlinear1974,dennisjr.QuasiNewtonMethodsMotivation1977}。次の更新
\fi
\begin{equation*}
