...
\end{equation*}
\ifEn
    Here, $\sigma^\mathrm{F}_k \in \mathbb{R}$ is a scalar to be determined.
\else
...
\ifEn
    This is a cubic-augmented modified secant condition. Unlike the function-value-matching quadratic modification, this formulation allows simultaneous satisfaction of both the function value and gradient conditions at the previous point through the introduction of the tensor term.
