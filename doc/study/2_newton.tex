...
\ifEn
    ...
    The modified Newton's method~\citep[Sec. 3.4]{nocedal1999numerical} is one remedy for handling such cases.
\else
...
\ifEn
    ...
    Newton's method equipped with line search is often referred to as the modified Newton's method and is known to possess global convergence properties.
\else
